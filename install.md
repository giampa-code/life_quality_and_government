# life quality and government guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `life_quality_and_government/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `life_quality_and_government` folder and use the modules inside your notebooks :
...
```python
from life_quality_and_government.utils.paths import data_dir
data_dir()
```
